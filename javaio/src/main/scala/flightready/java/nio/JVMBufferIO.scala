...
class NIOByteBufferModule[F[_]](implicit tw: ThunkWrap[F]) extends IsoByteBufferIO.Module[F] {
  def allocate(capacity: Int): F[NIOByteBufferIO[F]] =
    tw(new NIOByteBufferIO[F](ByteBuffer.allocate(capacity), tw))

  def allocateDirect(capacity: Int): F[NIOByteBufferIO[F]] =
    tw(new NIOByteBufferIO[F](ByteBuffer.allocateDirect(capacity), tw))

  def wrapArray(shorts: Array[Byte]): F[NIOByteBufferIO[F]] =
    tw(new NIOByteBufferIO[F](ByteBuffer.wrap(shorts), tw))
  def wrapArraySlice(shorts: Array[Byte], ofs: Int, len: Int): F[NIOByteBufferIO[F]] =
    tw(new NIOByteBufferIO[F](ByteBuffer.wrap(shorts, ofs, len), tw))
...
class NIOByteBufferReadIO[F[_]](private[nio] val buf: ByteBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[ByteBufferReadIO[F]] = tw(new NIOByteBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[ByteBufferReadIO[F]] = tw(new NIOByteBufferReadIO[F](buf.slice, tw))

  def asCharBufferRO: F[CharBufferReadIO[F]] = tw(new NIOCharBufferReadIO[F](buf.asCharBuffer, tw))
  def asShortBufferRO: F[ShortBufferReadIO[F]] = tw(new NIOShortBufferReadIO[F](buf.asShortBuffer, tw))
  def asIntBufferRO: F[IntBufferReadIO[F]] = tw(new NIOIntBufferReadIO[F](buf.asIntBuffer, tw))
  def asLongBufferRO: F[LongBufferReadIO[F]] = tw(new NIOLongBufferReadIO[F](buf.asLongBuffer, tw))
  def asFloatBufferRO: F[FloatBufferReadIO[F]] = tw(new NIOFloatBufferReadIO[F](buf.asFloatBuffer, tw))
  def asDoubleBufferRO: F[DoubleBufferReadIO[F]] = tw(new NIODoubleBufferReadIO[F](buf.asDoubleBuffer, tw))
...
class NIOByteBufferIO[F[_]](buf: ByteBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[ByteBufferReadIO[F]] = tw(new NIOByteBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[ByteBufferReadIO[F]] = tw(new NIOByteBufferReadIO(buf.asReadOnlyBuffer.slice, tw))
  ...
  override def asShortBufferRO: F[ShortBufferReadIO[F]] =
    tw(new NIOShortBufferReadIO[F](buf.asReadOnlyBuffer.asShortBuffer, tw))
  override def asIntBufferRO: F[IntBufferReadIO[F]] =
    tw(new NIOIntBufferReadIO[F](buf.asReadOnlyBuffer.asIntBuffer, tw))
  override def asLongBufferRO: F[LongBufferReadIO[F]] =
    tw(new NIOLongBufferReadIO[F](buf.asReadOnlyBuffer.asLongBuffer, tw))
  override def asFloatBufferRO: F[FloatBufferReadIO[F]] =
    tw(new NIOFloatBufferReadIO[F](buf.asReadOnlyBuffer.asFloatBuffer, tw))
  override def asDoubleBufferRO: F[DoubleBufferReadIO[F]] =
    tw(new NIODoubleBufferReadIO[F](buf.asReadOnlyBuffer.asDoubleBuffer, tw))

  def asCharBufferRW: F[CharBufferIO[F]] = tw(new NIOCharBufferIO[F](buf.asCharBuffer, tw))
  def asShortBufferRW: F[ShortBufferIO[F]] = tw(new NIOShortBufferIO[F](buf.asShortBuffer, tw))
  def asIntBufferRW: F[IntBufferIO[F]] = tw(new NIOIntBufferIO[F](buf.asIntBuffer, tw))
  def asLongBufferRW: F[LongBufferIO[F]] = tw(new NIOLongBufferIO[F](buf.asLongBuffer, tw))
  def asFloatBufferRW: F[FloatBufferIO[F]] = tw(new NIOFloatBufferIO[F](buf.asFloatBuffer, tw))
  ...
  def apply[F[_]](implicit tw: ThunkWrap[F]): IsoCharBufferIO.Module[F] =
    new IsoCharBufferIO.Module[F] {
      def allocate(capacity: Int): F[NIOCharBufferIO[F]] =
        tw(new NIOCharBufferIO[F](CharBuffer.allocate(capacity), tw))

      def wrapArray(shorts: Array[Char]): F[NIOCharBufferIO[F]] =
        tw(new NIOCharBufferIO[F](CharBuffer.wrap(shorts), tw))
      def wrapArraySlice(shorts: Array[Char], ofs: Int, len: Int): F[NIOCharBufferIO[F]] =
        tw(new NIOCharBufferIO[F](CharBuffer.wrap(shorts, ofs, len), tw))

      def wrapCharSequence(csq: CharSequence): F[NIOCharBufferReadIO[F]] =
        tw(new NIOCharBufferReadIO[F](CharBuffer.wrap(csq), tw))
      def wrapCharSequenceSlice(csq: CharSequence, start: Int, end: Int): F[NIOCharBufferReadIO[F]] =
        tw(new NIOCharBufferReadIO[F](CharBuffer.wrap(csq, start, end), tw))
...
class NIOCharBufferReadIO[F[_]](private[nio] val buf: CharBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[CharBufferReadIO[F]] = tw(new NIOCharBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[CharBufferReadIO[F]] = tw(new NIOCharBufferReadIO[F](buf.slice, tw))
  def subSequenceRO(start: Int, end: Int): F[CharBufferReadIO[F]] =
    tw(new NIOCharBufferReadIO[F](buf.subSequence(start, end), tw))
...
class NIOCharBufferIO[F[_]](buf: CharBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[CharBufferReadIO[F]] = tw(new NIOCharBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[CharBufferReadIO[F]] = tw(new NIOCharBufferReadIO(buf.slice.asReadOnlyBuffer(), tw))
  override def subSequenceRO(start: Int, end: Int): F[CharBufferReadIO[F]] =
    tw(new NIOCharBufferReadIO[F](buf.subSequence(start, end).asReadOnlyBuffer, tw))

  def duplicateRW: F[CharBufferIO[F]] = tw(new NIOCharBufferIO(buf.duplicate, tw))
  def sliceRW: F[CharBufferIO[F]] = tw(new NIOCharBufferIO(buf.slice, tw))
  def subSequenceRW(start: Int, end: Int): F[CharBufferIO[F]] =
    tw(new NIOCharBufferIO[F](buf.subSequence(start, end), tw))
  ...
  def apply[F[_]](implicit tw: ThunkWrap[F]): IsoShortBufferIO.Module[F] =
    new IsoShortBufferIO.Module[F] {
      def allocate(capacity: Int): F[NIOShortBufferIO[F]] =
        tw(new NIOShortBufferIO[F](ShortBuffer.allocate(capacity), tw))

      def wrapArray(shorts: Array[Short]): F[NIOShortBufferIO[F]] =
        tw(new NIOShortBufferIO[F](ShortBuffer.wrap(shorts), tw))
      def wrapArraySlice(shorts: Array[Short], ofs: Int, len: Int): F[NIOShortBufferIO[F]] =
        tw(new NIOShortBufferIO[F](ShortBuffer.wrap(shorts, ofs, len), tw))
...
class NIOShortBufferReadIO[F[_]](private[nio] val buf: ShortBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[ShortBufferReadIO[F]] = tw(new NIOShortBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[ShortBufferReadIO[F]] = tw(new NIOShortBufferReadIO[F](buf.slice, tw))
...
class NIOShortBufferIO[F[_]](buf: ShortBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[ShortBufferReadIO[F]] = tw(new NIOShortBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[ShortBufferReadIO[F]] = tw(new NIOShortBufferReadIO(buf.asReadOnlyBuffer.slice, tw))

  def duplicateRW: F[ShortBufferIO[F]] = tw(new NIOShortBufferIO(buf.duplicate, tw))
  def sliceRW: F[ShortBufferIO[F]] = tw(new NIOShortBufferIO(buf.slice, tw))
  ...
  def apply[F[_]](implicit tw: ThunkWrap[F]): IsoIntBufferIO.Module[F] =
    new IsoIntBufferIO.Module[F] {
      def allocate(capacity: Int): F[NIOIntBufferIO[F]] =
        tw(new NIOIntBufferIO[F](IntBuffer.allocate(capacity), tw))

      def wrapArray(ints: Array[Int]): F[NIOIntBufferIO[F]] =
        tw(new NIOIntBufferIO[F](IntBuffer.wrap(ints), tw))
      def wrapArraySlice(ints: Array[Int], ofs: Int, len: Int): F[NIOIntBufferIO[F]] =
        tw(new NIOIntBufferIO[F](IntBuffer.wrap(ints, ofs, len), tw))
...
class NIOIntBufferReadIO[F[_]](private[nio] val buf: IntBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[IntBufferReadIO[F]] = tw(new NIOIntBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[IntBufferReadIO[F]] = tw(new NIOIntBufferReadIO[F](buf.slice, tw))
...
class NIOIntBufferIO[F[_]](buf: IntBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[IntBufferReadIO[F]] = tw(new NIOIntBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[IntBufferReadIO[F]] = tw(new NIOIntBufferReadIO(buf.asReadOnlyBuffer.slice, tw))
  ...
  def apply[F[_]](implicit tw: ThunkWrap[F]): IsoLongBufferIO.Module[F] =
    new IsoLongBufferIO.Module[F] {
      def allocate(capacity: Int): F[NIOLongBufferIO[F]] =
        tw(new NIOLongBufferIO[F](LongBuffer.allocate(capacity), tw))

      def wrapArray(floats: Array[Long]): F[NIOLongBufferIO[F]] =
        tw(new NIOLongBufferIO[F](LongBuffer.wrap(floats), tw))
      def wrapArraySlice(floats: Array[Long], ofs: Int, len: Int): F[NIOLongBufferIO[F]] =
        tw(new NIOLongBufferIO[F](LongBuffer.wrap(floats, ofs, len), tw))
...
class NIOLongBufferReadIO[F[_]](private[nio] val buf: LongBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[LongBufferReadIO[F]] = tw(new NIOLongBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[LongBufferReadIO[F]] = tw(new NIOLongBufferReadIO[F](buf.slice, tw))
...
class NIOLongBufferIO[F[_]](buf: LongBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[LongBufferReadIO[F]] = tw(new NIOLongBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[LongBufferReadIO[F]] = tw(new NIOLongBufferReadIO(buf.asReadOnlyBuffer.slice, tw))
  ...
  def apply[F[_]](implicit tw: ThunkWrap[F]): IsoFloatBufferIO.Module[F] =
    new IsoFloatBufferIO.Module[F] {
      def allocate(capacity: Int): F[NIOFloatBufferIO[F]] =
        tw(new NIOFloatBufferIO[F](FloatBuffer.allocate(capacity), tw))

      def wrapArray(floats: Array[Float]): F[NIOFloatBufferIO[F]] =
        tw(new NIOFloatBufferIO[F](FloatBuffer.wrap(floats), tw))
      def wrapArraySlice(floats: Array[Float], ofs: Int, len: Int): F[NIOFloatBufferIO[F]] =
        tw(new NIOFloatBufferIO[F](FloatBuffer.wrap(floats, ofs, len), tw))
...
class NIOFloatBufferReadIO[F[_]](private[nio] val buf: FloatBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[FloatBufferReadIO[F]] = tw(new NIOFloatBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[FloatBufferReadIO[F]] = tw(new NIOFloatBufferReadIO[F](buf.slice, tw))
...
class NIOFloatBufferIO[F[_]](buf: FloatBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[FloatBufferReadIO[F]] = tw(new NIOFloatBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[FloatBufferReadIO[F]] = tw(new NIOFloatBufferReadIO(buf.asReadOnlyBuffer.slice, tw))
  ...
  def apply[F[_]](implicit tw: ThunkWrap[F]): IsoDoubleBufferIO.Module[F] =
    new IsoDoubleBufferIO.Module[F] {
      def allocate(capacity: Int): F[NIODoubleBufferIO[F]] =
        tw(new NIODoubleBufferIO[F](DoubleBuffer.allocate(capacity), tw))

      def wrapArray(doubles: Array[Double]): F[NIODoubleBufferIO[F]] =
        tw(new NIODoubleBufferIO[F](DoubleBuffer.wrap(doubles), tw))
      def wrapArraySlice(doubles: Array[Double], ofs: Int, len: Int): F[NIODoubleBufferIO[F]] =
        tw(new NIODoubleBufferIO[F](DoubleBuffer.wrap(doubles, ofs, len), tw))
...
class NIODoubleBufferReadIO[F[_]](private[nio] val buf: DoubleBuffer, val tw: ThunkWrap[F])
  ...
  def duplicateRO: F[DoubleBufferReadIO[F]] = tw(new NIODoubleBufferReadIO(buf.duplicate, tw))
  def sliceRO: F[DoubleBufferReadIO[F]] = tw(new NIODoubleBufferReadIO[F](buf.slice, tw))
...
class NIODoubleBufferIO[F[_]](buf: DoubleBuffer, tw: ThunkWrap[F])
  ...
  override def duplicateRO: F[DoubleBufferReadIO[F]] = tw(new NIODoubleBufferReadIO(buf.asReadOnlyBuffer, tw))
  override def sliceRO: F[DoubleBufferReadIO[F]] = tw(new NIODoubleBufferReadIO(buf.asReadOnlyBuffer.slice, tw))
